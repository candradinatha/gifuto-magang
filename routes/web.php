...
Route::get('admin/seller/{id_seller}','AdminGifutoController@detailseller')->name('admin.detailseller');
Route::get('admin/seller/{id_seller}/kado/{id_kado}','AdminGifutoController@detailkado')->name('admin.detailkado');
